...
## 4. Entrées à ajouter (dette bibliographique)

À compléter au fil du cadrage — chaque « fait » encore non sourcé doit recevoir sa notice avant d'entrer dans `SPEC.md` :

- [x] ~~Résultat de la contre-vérification du PDF MRNF~~ — faite le 2026-07-05, intégrée à [REF-01] et `DATA_REFERENCE.md` §7.
- [x] ~~Codes EPSG UTM pour la V2 Canada~~ — fournis par [REF-01] (fuseaux 17–21 : NAD83 26917–26921, CSRS 2958–2962), bornes vérifiées [REF-09] ; vérification exhaustive à faire au démarrage de la V2.
- [x] ~~Page NRCan sur le CSRS et les transformations~~ — soldée le 2026-07-05 : [REF-14].
- [x] ~~Documentation Typer / Rich / Jinja2~~ — soldée le 2026-07-05 : [REF-22] à [REF-24] (versions exactes à figer dans `pyproject.toml` au démarrage du code).
- [x] ~~Limite administrative du Québec~~ — soldée le 2026-07-05 : [REF-15] (Découpages administratifs, MRNF, **CC-BY 4.0** — redistribution permise avec attribution).

*(Aucune dette ouverte. Prochaine échéance de vérification : codes UTM exhaustifs au démarrage de la V2 — cf. [REF-01]/[REF-09].)*
